...
public class ClientesGUI extends JFrame {
	 ...
	 */
	public ClientesGUI() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ClientesGUI.class.getResource("/imagens/Group2_Buyers_Dark.png")));
		...
		btnNewButtonIncluir.setIcon(new ImageIcon(ClientesGUI.class.getResource("/imagens/add.png")));
		...
		btnNewButtonCancelar.setIcon(new ImageIcon(ClientesGUI.class.getResource("/imagens/DeleteRed.png")));
