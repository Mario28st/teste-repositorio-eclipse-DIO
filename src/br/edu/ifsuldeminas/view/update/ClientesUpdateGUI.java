...
public class ClientesUpdateGUI extends JFrame {
	...
	public ClientesUpdateGUI() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ClientesUpdateGUI.class.getResource("/img/Group2_Buyers_Dark.png")));
		...
		btnNewButtonIncluir.setIcon(new ImageIcon(ClientesUpdateGUI.class.getResource("/img/Dialog-Apply-32.png")));
		...
		btnNewButtonCancelar.setIcon(new ImageIcon(ClientesUpdateGUI.class.getResource("/img/DeleteRed.png")));
