...
public class SearchClientesGUI extends JDialog {
	...
	public SearchClientesGUI() {
		...
		JButton btnSelecionarIdentifier = new JButton("Selecionar");
		...
		btnSelecionarIdentifier.setIcon(new ImageIcon(SearchClientesGUI.class.getResource("/img/thumbs_up.png")));
		...
		btnFechar.setIcon(new ImageIcon(SearchClientesGUI.class.getResource("/img/thumbs_down.png")));
