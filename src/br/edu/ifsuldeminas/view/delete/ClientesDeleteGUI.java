...
public class ClientesDeleteGUI extends JFrame {
	...
	public ClientesDeleteGUI() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ClientesDeleteGUI.class.getResource("/imagens/Group2_Buyers_Dark.png")));
		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			    ...
			    int input = JOptionPane.showConfirmDialog(null, "Confirma a exclus√£o do funcion√°rio: " + nome + " " + sobrenome  , "AtenÁ„o !", JOptionPane.YES_NO_OPTION);
		...
		btnExcluir.setIcon(new ImageIcon(ClientesDeleteGUI.class.getResource("/imagens/Gnome-Process-Stop-32.png")));
		...
		btnNewButtonCancelar.setIcon(new ImageIcon(ClientesDeleteGUI.class.getResource("/imagens/DeleteRed.png")));
		
		JLabel lblNewLabel_6 = new JLabel("Exclus„o de Clientes");
		...
		JLabel lblNewLabel_7 = new JLabel("Sal·rio");
