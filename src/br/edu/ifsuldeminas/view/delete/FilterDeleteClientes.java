...
public class FilterDeleteClientes extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FilterDeleteClientes frame = new FilterDeleteClientes();
	 ...
	 * Create the frame.
	 */
	public FilterDeleteClientes() {
		setResizable(false);
		setTitle("Filtro para Exclusão");
		...
		JLabel lblNewLabel = new JLabel("Selecione  o Id para excluir");
		...
		JLabel lblNewLabel_2 = new JLabel("Id para excluir");
		...
		btnOK.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int id = Integer.parseInt(textFieldId.getText());
					...
					ClientesDeleteGUI gui = new ClientesDeleteGUI();
