package br.edu.ifsuldeminas.view.report;
...
import br.edu.ifsuldeminas.cadastro.*;
...
public class ClientesReportGUI extends JFrame {
	...
	public ClientesReportGUI() {
		setAlwaysOnTop(true);
		setIconImage(Toolkit.getDefaultToolkit().getImage(ClientesReportGUI.class.getResource("/imagens/Group2_Buyers_Dark.png")));
		...
		btnExecutarRel.setIcon(new ImageIcon(ClientesReportGUI.class.getResource("/imagens/5355693_analysis_analytics_chart_data_document_icon (1).png")));
		...
		btnCancelar.setIcon(new ImageIcon(ClientesReportGUI.class.getResource("/imagens/DeleteRed.png")));
		...
		gl_panelSul.setHorizontalGroup(
			gl_panelSul.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_panelSul.createSequentialGroup()
					...
					.addComponent(btnExecutarRel, GroupLayout.PREFERRED_SIZE, 174, GroupLayout.PREFERRED_SIZE)
					.addGap(166)
					.addComponent(btnCancelar, GroupLayout.PREFERRED_SIZE, 174, GroupLayout.PREFERRED_SIZE)
					.addGap(228))
		);
